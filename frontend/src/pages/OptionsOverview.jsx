        ...
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              An <strong>option</strong> is a financial contract that gives the holder the right, but not the obligation, 
              to buy or sell an underlying asset at a specified price (strike price) within a certain time period.
            </p>
            ...
            <div className="bg-blue-100 border-2 border-blue-300 text-blue-900 p-6 rounded-xl mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p>
                    Options provide leverage and flexibility, allowing traders to control larger positions 
                    with less capital while limiting potential losses to the premium paid.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-xl">
              ...
              <p className="text-green-700 mb-4 text-lg">
                Gives the right to <strong>buy</strong> the underlying asset at the strike price.
              </p>
              <div className="space-y-2 text-green-800">
                <p><strong>Market outlook:</strong> Bullish (expecting price to rise)</p>
                <p><strong>Profit when:</strong> Asset price &gt; Strike price + Premium</p>
                <p><strong>Maximum loss:</strong> Limited to premium paid</p>
                <p><strong>Maximum profit:</strong> Unlimited upside potential</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-rose-50 border-2 border-red-200 p-6 rounded-xl">
              ...
              <p className="text-red-700 mb-4 text-lg">
                Gives the right to <strong>sell</strong> the underlying asset at the strike price.
              </p>
              <div className="space-y-2 text-red-800">
                <p><strong>Market outlook:</strong> Bearish (expecting price to fall)</p>
                <p><strong>Profit when:</strong> Strike price - Premium &gt; Asset price</p>
                <p><strong>Maximum loss:</strong> Limited to premium paid</p>
                <p><strong>Maximum profit:</strong> K - Premium (when stock goes to zero)</p>
              </div>
            </div>
          </div>

          <div className="bg-gray-50 border-2 border-gray-200 p-6 rounded-xl">
            <h4 className="font-bold text-gray-600 text-xl mb-4">Option Types by Exercise Style</h4>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h5 className="font-bold text-blue-800 mb-2">American Options</h5>
                <p className="text-blue-700 text-sm">Can be exercised at any time before expiration</p>
                <button
              ...
              <div className="text-center">
                ...
                <h5 className="font-bold text-purple-800 mb-2">European Options</h5>
                <p className="text-purple-700 text-sm">Can only be exercised at expiration date</p>
                <button
              ...
              <div className="text-center">
                ...
                <h5 className="font-bold text-orange-800 mb-2">Asian Options</h5>
                <p className="text-orange-700 text-sm">Payoff depends on average price over time</p>
                <button
        ...
        <div className="space-y-6">
          <div className="text-lg text-gray-700 mb-8">
            <p className="leading-relaxed">
              Mastering options terminology is essential for effective trading. These key concepts form 
              the foundation of all options strategies and pricing models.
            </p>
          </div>
            ...
            {[
              {
                ...
                example: "A call option with K=$100 allows buying the stock at $100",
                color: "red",
                icon: "🎯"
              },
              {
              ...
              <div key={index} className={`bg-gradient-to-br from-${item.color}-50 to-${item.color}-100 border-2 border-${item.color}-200 rounded-xl p-6`}>
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 bg-gradient-to-r from-${item.color}-500 to-${item.color}-600 rounded-full flex items-center justify-center flex-shrink-0 text-xl`}>
                    {item.icon}
                  </div>
                  <div className="flex-1">
                    <h4 className={`font-bold text-${item.color}-900 text-xl mb-2`}>{item.term}</h4>
                    <p className={`text-${item.color}-800 mb-3 text-lg`}>{item.definition}</p>
                    <div className={`bg-white/60 p-3 rounded-lg border border-${item.color}-300`}>
                      <p className={`text-sm text-${item.color}-700 italic font-medium`}>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl p-8 mt-8">
            <h4 className="font-bold text-2xl mb-6 text-center">📊 Moneyness Quick Reference</h4>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/20 rounded-lg p-4 text-center">
                <div className="text-3xl mb-2">📈</div>
                <h5 className="font-bold mb-2">In-the-Money (ITM)</h5>
                <p className="text-sm text-purple-100">Call: S {'>'} K | Put: S {'<'} K</p>
                <p className="text-xs text-purple-200 mt-2">Has intrinsic value</p>
              </div>
              <div className="bg-white/20 rounded-lg p-4 text-center">
                <div className="text-3xl mb-2">⚖️</div>
                <h5 className="font-bold mb-2">At-the-Money (ATM)</h5>
                <p className="text-sm text-purple-100">S ≈ K</p>
                <p className="text-xs text-purple-200 mt-2">Zero intrinsic value</p>
              </div>
              <div className="bg-white/20 rounded-lg p-4 text-center">
                <div className="text-3xl mb-2">📉</div>
                <h5 className="font-bold mb-2">Out-of-the-Money (OTM)</h5>
                <p className="text-sm text-purple-100">Call: S {'<'} K | Put: S {'>'} K</p>
                <p className="text-xs text-purple-200 mt-2">Only time value remains</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div>
            <p className="text-lg text-gray-700 mb-6">
              Understanding how options make or lose money at expiration is crucial for successful trading. 
              The payoff diagram shows the profit or loss at different stock prices.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6">
              ...
              <div className="bg-white/80 p-4 rounded-lg mb-6 border border-green-300">
                <div className="text-center mb-4">
                  <h5 className="font-semibold text-green-800 mb-2">Payoff Formula</h5>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div><strong>S:</strong> Stock price at expiration</div>
                  <div><strong>K:</strong> Strike price</div>
                  <div><strong>Premium:</strong> Cost paid for option</div>
                  <div><strong>max():</strong> Take the higher value</div>
                </div>
              </div>

              <div className="space-y-4">
                <div className="bg-white/80 p-4 rounded-lg border border-green-300">
                  <h6 className="font-semibold text-green-800 mb-2">Breakeven Point</h6>
                  <p className="text-green-700">Stock Price = Strike Price + Premium Paid</p>
                </div>
                <div className="bg-white/80 p-4 rounded-lg border border-green-300">
                  <h6 className="font-semibold text-green-800 mb-2">Risk/Reward Profile</h6>
                  <div className="space-y-2 text-green-700">
                    <p><strong>Maximum Loss:</strong> Limited to premium paid</p>
                    <p><strong>Maximum Profit:</strong> Unlimited (as stock price rises)</p>
                    <p><strong>Probability:</strong> Higher success rate at lower strikes</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-rose-50 border-2 border-red-200 rounded-xl p-6">
              ...
              <div className="bg-white/80 p-4 rounded-lg mb-6 border border-red-300">
                <div className="text-center mb-4">
                  <h5 className="font-semibold text-red-800 mb-2">Payoff Formula</h5>
              ...
              <div className="space-y-4">
                <div className="bg-white/80 p-4 rounded-lg border border-red-300">
                  <h6 className="font-semibold text-red-800 mb-2">Breakeven Point</h6>
                  <p className="text-red-700">Stock Price = Strike Price - Premium Paid</p>
                </div>
                <div className="bg-white/80 p-4 rounded-lg border border-red-300">
                  <h6 className="font-semibold text-red-800 mb-2">Risk/Reward Profile</h6>
                  <div className="space-y-2 text-red-700">
                    <p><strong>Maximum Loss:</strong> Limited to premium paid</p>
                    <p><strong>Maximum Profit:</strong> K - Premium (when stock → $0)</p>
                    <p><strong>Probability:</strong> Higher success rate at higher strikes</p>
                  </div>
                </div>
              </div>
            </div>
...
<div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 p-6 rounded-xl">
  <div className="flex items-start space-x-4">
    ...
    <div>
      <h4 className="font-bold text-xl mb-3 text-blue-800">Interactive Practice</h4>
      <p className="mb-4 text-blue-700">
        Want to see these payoffs in action? Use our OptiPrice calculator to experiment 
        with different strike prices, expiration dates, and see how option values and 
        payoffs change in real-time.
      </p>
      <button
    ...
    factors: {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Beyond basic terminology, successful options trading requires understanding market dynamics, 
              pricing sensitivities, and real-world factors that influence option values minute by minute.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-indigo-100 border-2 border-purple-200 rounded-xl p-8 mb-8">
            ...
            <p className="text-purple-700 mb-6">
              The Greeks quantify how option prices respond to market changes, essential for risk management and strategy selection.
            </p>
            
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white/60 border border-purple-300 rounded-lg p-4">
                <h5 className="font-bold mb-2 text-purple-800">First-Order Greeks</h5>
                <div className="space-y-1 text-sm text-purple-700">
                  <p><strong>Delta (Δ):</strong> Price sensitivity</p>
                  <p><strong>Vega (ν):</strong> Volatility sensitivity</p>
                  <p><strong>Theta (Θ):</strong> Time decay</p>
                  <p><strong>Rho (ρ):</strong> Interest rate risk</p>
                </div>
              </div>
              <div className="bg-white/60 border border-purple-300 rounded-lg p-4">
                <h5 className="font-bold mb-2 text-purple-800">Second-Order Greeks</h5>
                <div className="space-y-1 text-sm text-purple-700">
                  <p><strong>Gamma (Γ):</strong> Delta acceleration</p>
                  <p><strong>Vanna:</strong> Vega-Delta interaction</p>
                  <p><strong>Charm:</strong> Delta time decay</p>
                  <p><strong>Volga:</strong> Vega convexity</p>
                </div>
              </div>
              <div className="bg-white/60 border border-purple-300 rounded-lg p-4">
                <h5 className="font-bold mb-2 text-purple-800">Portfolio Greeks</h5>
                <div className="space-y-1 text-sm text-purple-700">
                  <p><strong>Net Delta:</strong> Directional exposure</p>
                  <p><strong>Gamma Exposure:</strong> Convexity risk</p>
                  <p><strong>Vega Risk:</strong> Vol sensitivity</p>
                  <p><strong>Theta Burn:</strong> Time decay P&L</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-rose-100 border-2 border-red-200 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="bg-white/60 p-3 rounded-lg border border-red-300">
                  ...
                  <p className="text-red-600 text-sm">Wide bid-ask spreads, low volume, difficulty exiting positions</p>
                </div>
                <div className="bg-white/60 p-3 rounded-lg border border-red-300">
                  <h5 className="font-semibold text-red-700">Assignment Risk</h5>
                  <p className="text-red-600 text-sm">Early exercise on American options, especially near ex-dividend dates</p>
                </div>
                <div className="bg-white/60 p-3 rounded-lg border border-red-300">
                  <h5 className="font-semibold text-red-700">Model Risk</h5>
                  <p className="text-red-600 text-sm">Black-Scholes assumptions don't always hold in real markets</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="bg-white/60 p-3 rounded-lg border border-blue-300">
                  ...
                  <p className="text-blue-600 text-sm">Bull/bear markets, trending vs range-bound, volatility environment</p>
                </div>
                <div className="bg-white/60 p-3 rounded-lg border border-blue-300">
                  <h5 className="font-semibold text-blue-700">Time Horizon</h5>
                  <p className="text-blue-600 text-sm">Day trading vs swing trading vs long-term positioning</p>
                </div>
                <div className="bg-white/60 p-3 rounded-lg border border-blue-300">
                  <h5 className="font-semibold text-blue-700">Capital Allocation</h5>
                  <p className="text-blue-600 text-sm">Position sizing, risk per trade, portfolio correlation</p>
                </div>
              </div>
            </div>
          </div>
...
<div className="bg-gradient-to-br from-emerald-50 to-teal-100 border-2 border-emerald-200 rounded-xl p-8">
  ...
  <p className="text-emerald-700 mb-6 text-lg">
    Now that you understand the fundamentals, explore specific option types and advanced pricing models.
  </p>
  ...
  <div className="grid md:grid-cols-3 gap-4 mb-6">
    ...
    >
      <h5 className="font-bold mb-2 text-emerald-800">American Options</h5>
      <p className="text-sm text-emerald-700 flex-1">Early exercise features and optimal stopping theory</p>
    </button>
    <button
      onClick={() => navigate('/learning/options/european')}
      className="bg-white/60 hover:bg-white/80 border border-emerald-300 rounded-lg p-4 text-left transition-colors h-full flex flex-col"
    >
      <h5 className="font-bold mb-2 text-emerald-800">European Options</h5>
      <p className="text-sm text-emerald-700 flex-1">Classic Black-Scholes framework and closed-form solutions</p>
    </button>
    <button
      onClick={() => navigate('/learning/options/asian')}
      className="bg-white/60 hover:bg-white/80 border border-emerald-300 rounded-lg p-4 text-left transition-colors h-full flex flex-col"
    >
      <h5 className="font-bold mb-2 text-emerald-800">Asian Options</h5>
      <p className="text-sm text-emerald-700 flex-1">Path-dependent payoffs and average price options</p>
    </button>
  </div>
</div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-100 border-2 border-amber-200 p-6 rounded-xl">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-xl mb-3 text-amber-800">Master These Concepts with OptiPrice</h4>
                <p className="mb-4 text-amber-700">
                  Experience how market dynamics affect pricing in real-time. Compare Black-Scholes, Binomial, 
                  and Monte Carlo models while experimenting with Greeks and sensitivity analysis.
                </p>
                <button
                  onClick={() => navigate('/toolbox/optiprice')}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200/50 p-4 mb-8">
            <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
              ...
              <span>1 of 7 lessons</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gradient-to-r from-blue-500 to-cyan-500 h-2 rounded-full" style={{width: '14%'}}></div>
            </div>
          </div>
...
<div 
  className={`bg-white border-2 border-gray-300 p-8 relative z-20 ${
    activeTab === 'basics' ? 'rounded-tr-2xl rounded-b-2xl' : 'rounded-2xl'
  }`}
  style={{marginTop: '-2px'}}
>
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={() => navigate('/learning/options/american')}
              className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200"
            >

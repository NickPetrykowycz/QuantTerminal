        ...
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              <strong>Asian options</strong> are exotic derivatives whose payoff
              depends on the average price of the underlying asset over a
              specified period, rather than just the price at expiration. This
              path-dependent feature makes them valuable for reducing volatility
              risk and manipulation concerns.
            </p>
            ...
            <div className="bg-amber-100 border-2 border-amber-300 text-amber-900 p-6 rounded-xl mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p>
                    Named after the Asian financial markets where they were
                    first widely traded in the 1980s, particularly in Japan for
                    currency hedging and commodity trading applications.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 rounded-xl">
              ...
              <ul className="space-y-3 text-blue-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span>
                    <strong>Reduced Volatility:</strong> Averaging smooths out
                    price fluctuations
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>
                    <strong>Lower Premiums:</strong> Less volatile = cheaper
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>
                    <strong>Manipulation Resistant:</strong> Hard to manipulate
                    average over time
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-1">•</span>
                  <span>
                    <strong>Natural Hedging:</strong> Matches cash flow patterns
                    for many businesses
                  </span>
                </li>
              </ul>
              ...
              <div className="mt-4 bg-white p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-600 text-sm mb-2">
                  <strong>Mathematical Principle:</strong> When you average many
                  random observations, the variance of the average decreases by
                  the number of observations.
                </p>
                <p className="text-blue-600 text-sm">
                  <strong>Practical Example:</strong> If daily oil prices swing
                  ±$5, the average over 30 days will typically swing much less
                  than ±$5, making the option payoff more predictable.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-200 p-6 rounded-xl">
              ...
              <ul className="space-y-3 text-orange-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span>
                    <strong>Complex Pricing:</strong> No closed-form solutions
                    for most cases
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-orange-500 mt-1">•</span>
                  <span>
                    <strong>Path Dependency:</strong> Must track entire price
                    history
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-orange-500 mt-1">•</span>
                  <span>
                    <strong>Computational Intensity:</strong> Requires numerical
                    methods
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-orange-500 mt-1">•</span>
                  <span>
                    <strong>Limited Liquidity:</strong> Mainly OTC market with
              ...
              <div className="mt-4 bg-white p-4 rounded-lg border border-orange-200">
                <h5 className="font-semibold text-orange-700 mb-2">
                  Why Manipulation Resistant?
                </h5>
                <p className="text-orange-600 text-sm mb-2">
                  <strong>The Challenge:</strong> To manipulate an Asian
                  option's payoff, you'd need to manipulate the average price
                  over the entire averaging period.
                </p>
                <p className="text-orange-600 text-sm">
                  <strong>Example:</strong> Even if someone pushes oil prices up
                  10% on the last day, if it's a 30-day average, that only
                  affects 1/30th of the average price calculation.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm">
                    Where <InlineMath math="\bar{S}" /> is the average price
                    over the monitoring period
                  </p>
                </div>
                <div className="text-green-700 text-sm">
                  <p>
                    <strong>Most Common:</strong> 85% of Asian options are
                    average price
                  </p>
                  <p>
                    <strong>Use Case:</strong> Currency hedging, commodity price
                    protection
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  ...
                  <p className="text-purple-600 text-sm">
                    Where <InlineMath math="S_T" /> is the final price and{" "}
                    <InlineMath math="\bar{S}" /> is the average strike
                  </p>
                </div>
                <div className="text-purple-700 text-sm">
                  <p>
                    <strong>Usage:</strong> 15% of Asian options are average
                    strike
                  </p>
                  <p>
                    <strong>Benefit:</strong> Strike automatically adjusts to
                    market conditions
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <div className="text-gray-600 text-sm space-y-2">
                  <p>
                    <strong>Simple example:</strong> Prices $100, $110, $90
                  </p>
                  <p>
                    <strong>Arithmetic average:</strong> (100+110+90)/3 = $100
                  </p>
                  <p>
                    <strong>Usage:</strong> 95% of Asian options use this method
                  </p>
                  <p>
                    <strong>Pricing:</strong> Requires Monte Carlo simulation
                  </p>
                </div>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <div className="text-gray-600 text-sm space-y-2">
                  <p>
                    <strong>Same example:</strong> Prices $100, $110, $90
                  </p>
                  <p>
                    <strong>Geometric average:</strong> (100×110×90)^(1/3) =
                    $99.50
                  </p>
                  <p>
                    <strong>Usage:</strong> 5% of Asian options (mainly
                    theoretical)
                  </p>
                  <p>
                    <strong>Pricing:</strong> Has exact closed-form solution
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-blue-600 text-sm">
                <div>
                  ...
                  <p>
                    This means geometric Asian options are always cheaper to buy
                  </p>
                </div>
                <div>
                  <p>
                    <strong>Difference increases with volatility</strong>
                  </p>
                  <p>
                    The more volatile the underlying, the bigger the gap between
                    the two averages
                  </p>
                </div>
              </div>
    ...
    pricing: {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Asian options present unique pricing challenges due to their
              path-dependent nature. Unlike European options with closed-form
              solutions, most Asian options require sophisticated numerical
          ...
          <div className="bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 p-6 rounded-xl">
            <h4 className="font-bold text-red-800 text-xl mb-4">
              The Pricing Challenge: Why Most Asian Options Need Numerical
              Methods
            </h4>
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg border border-red-200">
                <h5 className="font-semibold text-red-700 mb-2">
                  The Core Problem (For Arithmetic Averages)
                </h5>
                <p className="text-red-600 text-sm mb-3">
                  <strong>Simple Answer:</strong> Black-Scholes works because
                  stock prices are log-normally distributed. But when you add up
                  (average) many log-normal variables, the result isn't
                  log-normal anymore.
                </p>
                <p className="text-red-600 text-sm">
                  <strong>Why This Matters:</strong> Since 95% of Asian options
                  use arithmetic averaging, most Asian options can't use the
                  elegant Black-Scholes formula and require numerical methods.
                </p>
              </div>

              <div className="bg-white p-4 rounded-lg border border-red-200">
                <h5 className="font-semibold text-red-700 mb-2">
                  The Exception: Geometric Averages
                </h5>
                <p className="text-red-600 text-sm mb-3">
                  Geometric averages of log-normal variables ARE still
                  log-normal, so they do have closed-form solutions. However,
                  these represent only ~5% of the Asian options market.
                </p>
                <p className="text-red-600 text-sm">
                  <strong>Bottom Line:</strong> The vast majority of real-world
                  Asian options (arithmetic averaging) require Monte Carlo
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm mb-2">
                    Matches first two moments of arithmetic average with a
                ...
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm mb-2">
                    Uses geometric average as control variate for arithmetic
                    average
                  </p>
                  <ul className="text-green-600 text-xs space-y-1">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 p-6 rounded-xl">
            <h4 className="font-bold text-amber-800 text-xl mb-4">
              Special Case: Geometric Average Closed-Form Solution
            </h4>
            <div className="bg-white p-4 rounded-lg border border-amber-200 mb-4">
              <div className="bg-amber-100 p-3 rounded-lg mb-3">
                <p className="text-amber-800 text-sm font-semibold">
                  ⚠️ Important: This only works for geometric averages, which
                  represent ~5% of Asian options market
                </p>
              </div>
              <p className="text-amber-700 mb-4">
                The geometric average Asian option is the only type with an
                exact closed-form solution, because geometric averages of
                log-normal variables remain log-normal. This allows us to use a
                modified Black-Scholes approach with adjusted parameters.
              </p>
            </div>
            ...
            <p className="text-amber-600 text-sm mt-3">
              Then use standard Black-Scholes formula with these adjusted
              parameters.
              <strong>Remember:</strong> This mathematical elegance is why
              geometric averaging is popular in academic studies, but arithmetic
              averaging dominates real markets.
            </p>
          </div>
        </div>
      ),
    ...
    markets: {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Asian options are primarily traded in OTC markets where their
              path-dependent features provide natural hedging solutions for
              businesses with exposure to average prices over time. Their
              applications span multiple asset classes and geographic regions.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm mb-2">
                    35% of Asian option volume
                  </p>
                  <p className="text-gray-600 text-sm">
                    Oil refiners, mining companies, and agricultural businesses
                    hedge average prices for continuous production and sales
                    cycles.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm mb-2">
                    25% of Asian option volume
                  </p>
                  <p className="text-gray-600 text-sm">
                    Fund managers and pension funds use Asian options for
                    dollar-cost averaging strategies and systematic investment
                    plans.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-gray-600 text-sm">
                    Growing adoption in commodity-linked structured products and
            ...
            <table className="w-full border-collapse">
              <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                <tr>
                  ...
                  <th className="border border-gray-300 p-4 text-left font-bold text-green-600">
                    Averaging Period
                  </th>
                </tr>
              </thead>
              <tbody className="bg-white">
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-4">
                    Refining margin protection, production hedging
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-4">
                    Metal price hedging, cost averaging
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-4">
                    Fuel cost hedging over operating periods
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-4">
                    Crop price floors, feed cost management
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-4">
                    Currency hedging for overseas revenue
                  </td>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-200 p-6 rounded-xl">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                ...
                <h5 className="font-semibold text-amber-700 mb-2">
                  Of OTC Options Volume
                </h5>
                <p className="text-gray-600 text-sm">
                  Asian options share of total exotic options market
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                <div className="text-2xl font-bold text-amber-700 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  Driven by commodity volatility and supply chain hedging
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                <div className="text-2xl font-bold text-amber-700 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  Nearly all Asian options are customized OTC contracts
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-200 p-6 rounded-xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="text-purple-600 text-sm space-y-2">
                  <li>
                    • Basel III capital treatment for path-dependent derivatives
                  </li>
    ...
    strategies: {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Asian options enable sophisticated risk management strategies that
              take advantage of their unique averaging properties. These
              strategies are particularly valuable for businesses with ongoing
              exposure to asset prices and institutional investors implementing
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm mb-2">
                    Commodity producers using average price calls
                  </p>
                  <p className="text-gray-600 text-sm">
                    Oil companies can protect against sustained low prices while
                    benefiting from temporary spikes, matching their continuous
                    production.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm mb-2">
                    Manufacturing companies using average price puts
                  </p>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm mb-2">
                    Multinationals using average FX options
                  </p>
                  <p className="text-gray-600 text-sm">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm mb-2">
                    Pension funds and systematic investors
                  </p>
                  <p className="text-gray-600 text-sm">
                    Protect systematic investment plans from adverse average
                    entry prices while maintaining exposure to market
                    appreciation.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm mb-2">
                    Hedge funds exploiting pricing inefficiencies
                  </p>
                  <p className="text-gray-600 text-sm">
                    Asian options typically trade with implied volatility 10-30%
                    lower than equivalent European options, creating arbitrage
                    opportunities.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-600 text-sm mb-2">
                    Banks creating retail investment products
                  </p>
                  <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-200 p-6 rounded-xl">
            <h4 className="font-bold text-purple-800 text-xl mb-4">
              Advanced Asian Option Strategies
            </h4>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-purple-200">
                <h5 className="font-semibold text-purple-700 mb-2">
                ...
                <p className="text-gray-600 text-sm mb-2">
                  Combine multiple Asian options with different strikes or
                  averaging periods to create tailored risk-reward profiles.
                </p>
              ...
              <div className="bg-white p-4 rounded-lg border border-purple-200">
                ...
                <p className="text-gray-600 text-sm mb-2">
                  Mix Asian and European features, such as European options on
                  Asian baskets or Asian options with European knockouts.
                </p>
                <p className="text-xs text-purple-600">
              ...
              <div className="bg-white p-4 rounded-lg border border-purple-200">
                ...
                <p className="text-gray-600 text-sm mb-2">
                  Asian options where the averaging period starts at a future
                  date, useful for seasonal business cycles.
                </p>
                <p className="text-xs text-purple-600">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-amber-600 text-sm space-y-2">
                  <li>
                    • <strong>Pricing accuracy:</strong> Monte Carlo convergence
                    requires many simulations
                  </li>
                  <li>
                    • <strong>Volatility assumptions:</strong> Constant
                    volatility rarely holds in practice
                  </li>
                  <li>
                    • <strong>Correlation effects:</strong> Time-series
                    correlations affect average distributions
                  </li>
                  <li>
                    • <strong>Discretization error:</strong> Continuous vs
                    discrete averaging differences
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-amber-600 text-sm space-y-2">
                  <li>
                    • <strong>Fixing disputes:</strong> Agreement on averaging
                    calculation methods
                  </li>
                  <li>
                    • <strong>Data quality:</strong> Reliable price feeds for
                    averaging periods
                  </li>
                  <li>
                    • <strong>Settlement complexity:</strong> Multiple
                    observation dates increase operational burden
                  </li>
                  <li>
                    • <strong>Liquidity risk:</strong> Limited secondary market
                    for unwinding positions
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-cyan-600 text-sm space-y-2">
                  <li>
                    • <strong>Averaging frequency:</strong> Daily for liquid
                    markets, weekly/monthly for others
                  </li>
                  <li>
                    • <strong>Business day adjustments:</strong> Clear rules for
                    holidays and market closures
                  </li>
                  <li>
                    • <strong>Price sources:</strong> Specify primary and backup
                    data providers
                  </li>
                  <li>
                    • <strong>Calculation agent:</strong> Independent third
                    party for complex structures
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-cyan-600 text-sm space-y-2">
                  <li>
                    • <strong>Delta hedging:</strong> More stable than European
                    options due to averaging
                  </li>
                  <li>
                    • <strong>Vega management:</strong> Lower vega makes
                    volatility hedging easier
                  </li>
                  <li>
                    • <strong>Gamma effects:</strong> Reduced gamma near
                    expiration compared to Europeans
                  </li>
                  <li>
                    • <strong>Path monitoring:</strong> Track running average
                    for early exercise decisions
                  </li>
                </ul>
              </div>
            </div>
    ...
    greeks: {
      ...
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Asian option Greeks behave differently from their European
              counterparts due to the averaging effect. The path-dependent
              nature creates unique risk characteristics that require
              specialized hedging approaches and risk management techniques.
            </p>
          </div>

          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 p-6 rounded-xl mb-8">
            <h4 className="font-bold text-amber-800 text-xl mb-4 text-center">
              How Averaging Affects Greeks
            </h4>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                ...
                <p className="text-amber-600 text-sm">
                  All Greeks typically 20-50% lower than European equivalents
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                <div className="text-2xl mb-2">🔄</div>
                ...
                <p className="text-amber-600 text-sm">
                  Greeks depend on running average, not just current price
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-amber-200 text-center">
                ...
                <p className="text-amber-600 text-sm">
                  Greeks change as averaging period progresses
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 bg-white p-4 rounded-lg border border-amber-200">
              <h5 className="font-semibold text-amber-700 mb-2">
                Why Greeks Are Dampened
              </h5>
              <p className="text-amber-600 text-sm mb-2">
                <strong>Intuitive Explanation:</strong> When only part of the
                averaging period remains, a price change has less impact on the
                final average. This "dilution effect" reduces all the
                sensitivities (Greeks) compared to European options.
              </p>
              <p className="text-amber-600 text-sm">
                <strong>Example:</strong> If 20 days of a 30-day average are
                already "locked in," today's 10% price move only affects 10/30 =
                33% of the final average calculation.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 rounded-xl">
              <h4 className="font-bold text-blue-800 text-xl mb-4">
                Delta (Δ) - Modified Price Sensitivity
              </h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  <h5 className="font-semibold text-blue-700 mb-2">
                    Asian Delta Characteristics
                  </h5>
                  <div className="text-blue-700 text-sm space-y-2">
                    <p>
                      <strong>Magnitude:</strong> Generally 30-60% of European
                      delta
                    </p>
                    <p>
                      <strong>Evolution:</strong> Decreases as averaging period
                      progresses
                    </p>
                    <p>
                      <strong>Dependency:</strong> Function of current price vs
                      running average
                    </p>
                    <p>
                      <strong>Stability:</strong> More stable than European
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-xl">
              <h4 className="font-bold text-green-800 text-xl mb-4">
                Gamma (Γ) - Reduced Convexity
              </h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  <h5 className="font-semibold text-green-700 mb-2">
                    Asian Gamma Behavior
                  </h5>
                  <div className="text-green-700 text-sm space-y-2">
                    <p>
                      <strong>Lower Peak:</strong> Maximum gamma 50-80% less
                      than European
                    </p>
                    <p>
                      <strong>Broader Distribution:</strong> Less concentrated
                      around ATM
                    </p>
                    <p>
                      <strong>Time Decay:</strong> Gamma decreases more
                      gradually
                    </p>
                    <p>
                      <strong>Averaging Effect:</strong> Smoothed price
                      sensitivity changes
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 border-2 border-purple-200 p-6 rounded-xl">
              <h4 className="font-bold text-purple-800 text-xl mb-4">
                Theta (Θ) - Complex Time Decay
              </h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  <h5 className="font-semibold text-purple-700 mb-2">
                    Two-Phase Time Decay
                  </h5>
                  <div className="text-purple-700 text-sm space-y-2">
                    <p>
                      <strong>Early Phase:</strong> Lower theta during averaging
                      period
                    </p>
                    <p>
                      <strong>Late Phase:</strong> Accelerated decay near
                      expiration
                    </p>
                    <p>
                      <strong>Path Dependence:</strong> Theta varies with
                      running average position
                    </p>
                    <p>
                      <strong>Averaging Complete:</strong> Reverts to
                      European-like behavior
                    </p>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  <h5 className="font-semibent text-purple-700 mb-2">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-orange-200">
                  <h5 className="font-semibold text-orange-700 mb-2">
                    Reduced Vega Profile
                  </h5>
                  <div className="text-orange-700 text-sm space-y-2">
                    <p>
                      <strong>Lower Sensitivity:</strong> Vega typically 40-70%
                      of European
                    </p>
                    <p>
                      <strong>Period Dependence:</strong> Higher early in
                      averaging period
                    </p>
                    <p>
                      <strong>Volatility Type:</strong> More sensitive to
                      long-term volatility
                    </p>
                    <p>
                      <strong>Smile Effects:</strong> Less pronounced volatility
                      smile impact
                    </p>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600 text-xs">
                  Lower than European due to averaging effect, but still
                  important for long-dated contracts with extended averaging
                  periods.
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600 text-sm mb-2">
                  Sensitivity to running average
                </p>
                <p className="text-gray-600 text-xs">
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <h5 className="font-semibold text-gray-700 mb-2">
                  Time Proportion Greek
                </h5>
                <p className="text-gray-600 text-sm mb-2">
                  Sensitivity to averaging progress
                </p>
                <p className="text-gray-600 text-xs">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-indigo-600 text-sm space-y-2">
                  <li>
                    • <strong>Lower hedge ratios:</strong> Reduced delta means
                    smaller hedge positions
                  </li>
                  <li>
                    • <strong>Stable Greeks:</strong> Less frequent risk
                    parameter updates needed
                  </li>
                  <li>
                    • <strong>Volatility protection:</strong> Natural hedge
                    against vol spikes
                  </li>
                  <li>
                    • <strong>Path monitoring:</strong> Track running average
              ...
              <div>
                <h5 className="font-semibent text-indigo-700 mb-3">
                  Portfolio Management
                </h5>
                <ul className="text-indigo-600 text-sm space-y-2">
                  <li>
                    • <strong>Diversification:</strong> Asian Greeks correlate
                    differently with markets
                  </li>
                  <li>
                    • <strong>Risk budgeting:</strong> Lower Greeks allow larger
                    position sizes
                  </li>
                  <li>
                    • <strong>Stress testing:</strong> More predictable behavior
                    in extreme scenarios
                  </li>
                  <li>
                    • <strong>Regulatory capital:</strong> Lower risk metrics
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 p-6 rounded-xl">
            <h4 className="font-bold text-emerald-800 text-xl mb-4">
              Greek Evolution Patterns
            </h4>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <h5 className="font-semibold text-emerald-700">
                  Early in Averaging Period
                </h5>

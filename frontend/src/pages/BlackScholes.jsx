...
const BlackScholes = () => {
  ...
  const tabContent = {
    ...
    greeks: {
      title: "Black-Scholes Greeks: The Risk Sensitivities",
      content: (
        <div className="space-y-8">
          <div>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              The Black-Scholes model provides exact analytical formulas for all the Greeks—the risk sensitivities 
              that measure how option prices change with market conditions. These Greeks are essential for 
              dynamic hedging, risk management, and understanding option behavior.
            </p>
          </div>

          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 rounded-xl mb-8">
            <h4 className="font-bold text-blue-800 text-xl mb-4 text-center">Why Black-Scholes Greeks Are Special</h4>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-blue-200 text-center">
                <div className="text-2xl mb-2">⚡</div>
                <h5 className="font-semibold text-blue-700 mb-2">Analytical Formulas</h5>
                <p className="text-blue-600 text-sm">Exact mathematical expressions, no approximation needed</p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-blue-200 text-center">
                <div className="text-2xl mb-2">🎯</div>
                <h5 className="font-semibold text-blue-700 mb-2">Real-Time Calculation</h5>
                <p className="text-blue-600 text-sm">Instant computation enables dynamic hedging strategies</p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-blue-200 text-center">
                <div className="text-2xl mb-2">🔗</div>
                <h5 className="font-semibold text-blue-700 mb-2">Mathematical Consistency</h5>
                <p className="text-blue-600 text-sm">All Greeks derived from same model, ensuring coherence</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  <h5 className="font-semibold text-green-700 mb-2">Exact Formulas</h5>
                  <div className="text-center bg-green-50 p-3 rounded space-y-2">
                    <div><InlineMath math="\Delta_{call} = N(d_1)" /></div>
                    <div><InlineMath math="\Delta_{put} = N(d_1) - 1" /></div>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  <h5 className="font-semibold text-green-700 mb-2">Practical Interpretation</h5>
                  <div className="text-green-600 text-sm space-y-2">
                    <p><strong>Range:</strong> Calls: 0 to 1, Puts: -1 to 0</p>
                    <p><strong>Hedge Ratio:</strong> Shares needed to hedge one option contract</p>
                    <p><strong>Moneyness:</strong> ATM ≈ 0.5, Deep ITM → 1, Deep OTM → 0</p>
                    <p><strong>Time Effect:</strong> ATM delta stays ~0.5, others approach 0 or 1</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 border-2 border-purple-200 p-6 rounded-xl">
              <h4 className="font-bold text-purple-800 text-xl mb-4">Gamma (Γ) - Delta Sensitivity</h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  <h5 className="font-semibold text-purple-700 mb-2">Exact Formula</h5>
                ...
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  <h5 className="font-semibold text-purple-700 mb-2">Key Characteristics</h5>
                  <div className="text-purple-600 text-sm space-y-2">
                    <p><strong>Maximum:</strong> At-the-money options near expiration</p>
                    <p><strong>Symmetry:</strong> Same value for calls and puts with same parameters</p>
                    <p><strong>Time Decay:</strong> Gamma increases as expiration approaches (ATM)</p>
                    <p><strong>Hedging:</strong> High gamma requires frequent delta rebalancing</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 p-6 rounded-xl">
              <h4 className="font-bold text-orange-800 text-xl mb-4">Theta (Θ) - Time Decay</h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-orange-200">
                  <h5 className="font-semibold text-orange-700 mb-2">Complete Formulas</h5>
                  <div className="text-center bg-orange-50 p-3 rounded text-sm space-y-2">
                    <div><InlineMath math="\Theta_{call} = -\frac{S_0 \phi(d_1) \sigma}{2\sqrt{T}} - rKe^{-rT}N(d_2)" /></div>
                    <div><InlineMath math="\Theta_{put} = -\frac{S_0 \phi(d_1) \sigma}{2\sqrt{T}} + rKe^{-rT}N(-d_2)" /></div>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-orange-200">
                  <h5 className="font-semibold text-orange-700 mb-2">Time Decay Patterns</h5>
                  <div className="text-orange-600 text-sm space-y-2">
                    <p><strong>ATM Options:</strong> Highest theta (fastest decay)</p>
                    <p><strong>ITM/OTM:</strong> Lower theta, especially deep options</p>
                    <p><strong>Acceleration:</strong> Decay speeds up near expiration</p>
                    <p><strong>Weekends:</strong> No theta decay when markets closed</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border-2 border-cyan-200 p-6 rounded-xl">
              <h4 className="font-bold text-cyan-800 text-xl mb-4">Vega (ν) - Volatility Sensitivity</h4>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-cyan-200">
                  <h5 className="font-semibold text-cyan-700 mb-2">Exact Formula</h5>
                  <div className="text-center bg-cyan-50 p-3 rounded">
                    <InlineMath math="\nu = S_0 \phi(d_1) \sqrt{T}" />
                  </div>
                  <p className="text-cyan-600 text-xs mt-2 text-center">
                    Same for calls and puts with identical parameters
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-cyan-200">
                  <h5 className="font-semibold text-cyan-700 mb-2">Vega Behavior</h5>
                  <div className="text-cyan-600 text-sm space-y-2">
                    <p><strong>Peak:</strong> ATM options with moderate time to expiration</p>
                    <p><strong>Time Effect:</strong> Vega decreases as expiration approaches</p>
                    <p><strong>Moneyness:</strong> Lower for deep ITM/OTM options</p>
                    <p><strong>Units:</strong> Change in option price per 1% volatility change</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 border-2 border-gray-200 p-6 rounded-xl">
            <h4 className="font-bold text-gray-800 text-xl mb-4">Higher-Order Greeks</h4>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <h5 className="font-semibold text-gray-700 mb-2">Rho (ρ) - Interest Rate Risk</h5>
                <div className="text-center bg-gray-50 p-2 rounded text-sm mb-2">
                  <InlineMath math="\rho_{call} = KTe^{-rT}N(d_2)" />
                </div>
                <p className="text-gray-600 text-xs">More significant for longer-dated options and interest rate-sensitive underlyings</p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <h5 className="font-semibold text-gray-700 mb-2">Vanna - Cross-Sensitivity</h5>
                <div className="text-center bg-gray-50 p-2 rounded text-sm mb-2">
                  <InlineMath math="\frac{\partial \Delta}{\partial \sigma} = \frac{\partial \nu}{\partial S}" />
                </div>
                <p className="text-gray-600 text-xs">How delta changes with volatility; important for volatility trading</p>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <h5 className="font-semibold text-gray-700 mb-2">Volga (Vomma)</h5>
                <div className="text-center bg-gray-50 p-2 rounded text-sm mb-2">
                  <InlineMath math="\frac{\partial^2 V}{\partial \sigma^2}" />
                </div>
                <p className="text-gray-600 text-xs">Convexity of option price with respect to volatility changes</p>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 p-6 rounded-xl">
            <h4 className="font-bold text-emerald-800 text-xl mb-4">Dynamic Hedging Applications</h4>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h5 className="font-semibold text-emerald-700 mb-3">Delta-Neutral Strategies</h5>
                <ul className="text-emerald-600 text-sm space-y-2">
                  <li>• <strong>Market makers:</strong> Hedge inventory risk with delta-neutral positions</li>
                  <li>• <strong>Portfolio insurance:</strong> Dynamic hedging using delta calculations</li>
                  <li>• <strong>Volatility trading:</strong> Isolate volatility exposure through delta hedging</li>
                  <li>• <strong>Gamma scalping:</strong> Profit from gamma while maintaining delta neutrality</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-emerald-700 mb-3">Multi-Greek Risk Management</h5>
                <ul className="text-emerald-600 text-sm space-y-2">
                  <li>• <strong>Theta strategies:</strong> Income generation through time decay</li>
                  <li>• <strong>Vega hedging:</strong> Manage volatility risk across option positions</li>
                  <li>• <strong>Gamma management:</strong> Control convexity risk in portfolios</li>
                  <li>• <strong>Cross-Greeks:</strong> Account for correlations between risk factors</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-200 p-6 rounded-xl">
            <h4 className="font-bold text-amber-800 text-xl mb-4">Greek Approximation Rules</h4>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-4 rounded-lg border border-amber-200">
                <h5 className="font-semibold text-amber-700 mb-3">Quick Estimation Formulas</h5>
                <div className="text-amber-600 text-sm space-y-2">
                  <p><strong>ATM Delta:</strong> ≈ 0.5 for both calls and puts</p>
                  <p><strong>ATM Gamma:</strong> ≈ 1/(S₀ × σ × √T)</p>
                  <p><strong>ATM Vega:</strong> ≈ S₀ × σ × √T / 4</p>
                  <p><strong>ATM Theta:</strong> ≈ -S₀ × σ / (2√T)</p>
                </div>
              </div>
              <div className="bg-white p-4 rounded-lg border border-amber-200">
                <h5 className="font-semibold text-amber-700 mb-3">Hedge Ratio Guidelines</h5>
                <div className="text-amber-600 text-sm space-y-2">
                  <p><strong>Delta hedge:</strong> Use N(d₁) shares per call option</p>
                  <p><strong>Gamma position:</strong> High gamma needs frequent rebalancing</p>
                  <p><strong>Theta income:</strong> Sell high-theta options for income strategies</p>
                  <p><strong>Vega exposure:</strong> Long volatility = positive vega position</p>
                </div>
              </div>
            </div>
          </div>
